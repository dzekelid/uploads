...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/uploads/master/_listings/aws-xray/apis.md
...
- name: AWS X-Ray API - Put Trace Segments
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/uploads/master/_listings/aws-xray/actionputtracesegments-get-openapi.md
- name: AWS X-Ray API - Put Trace Segments
  x-api-slug: actionputtracesegments-get
  description: Uploads segment documents to AWS X-Ray.
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/aws-xray.png
