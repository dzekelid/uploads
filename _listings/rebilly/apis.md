...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/uploads/master/_listings/rebilly/apis.md
specificationVersion: "0.14"
apis:
- name: Rebilly - Update the File with predefined ID. Note that file can be uploaded
    with POST only.
  x-api-slug: filesid-put
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/uploads/master/_listings/rebilly/filesid-put-openapi.md
- name: Rebilly - Update the File with predefined ID. Note that file can be uploaded
    with POST only.
  x-api-slug: filesid-put
  description: Update the File with predefined ID
