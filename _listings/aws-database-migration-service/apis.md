...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/uploads/master/_listings/aws-database-migration-service/apis.md
...
- name: AWS Database Migration Service API - Import Certificate
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/uploads/master/_listings/aws-database-migration-service/actionimportcertificate-get-openapi.md
- name: AWS Database Migration Service API - Import Certificate
  x-api-slug: actionimportcertificate-get
  description: Uploads the specified certificate.
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/Database_AWSDatabaseMigrationService.png
